...
$(document).ready(function() {
  ...
  function makeColor(hslList, fade) {
    return "hsl(" + hslList[0] + "," + (((255 - fade) / 255) * 40 + 60) +
      "%," + hslList[1] + "%)";
  };
  ...
  function init() {
    ...
    for (var i = 0; i < gLength; i++) {
      ...
      g[i].originalPos.x = (canvasWidth / 2 - offset / 2) + g[i].originalPos
        .x;
  ...
  function PointCollection() {
    ...
    this.update = function() {
      ...
      for (var i = 0; i < pointsLength; i++) {
        ...
        if (d < 150) {
          point.targetPos.x = (this.mousePos.x < point.curPos.x) ?
            point.curPos.x - dx : point.curPos.x - dx;
          point.targetPos.y = (this.mousePos.y < point.curPos.y) ?
            point.curPos.y - dy : point.curPos.y - dy;
        } else {
